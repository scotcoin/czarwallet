...
var ORDER_CZRSELL_DEFAULT_EXPIRATION = 2000; //num blocks until expiration for selling CZR order
...
var NUM_BLOCKS_TO_WAIT_FOR_CZRPAY = 6; //number of blocks to wait until the user can make a CZRpay on an order match where they owe CZR
...
var DEFAULT_PREFERENCES = {
  ...
  'auto_czrpay': true, //default to auto CZR payments being enabled
